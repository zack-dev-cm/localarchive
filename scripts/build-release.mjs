...
const zipName = `localarchive-${manifest.version}.zip`;
...
await writeFile(join(distDir, "launch-manifest.json"), `${JSON.stringify({
  ...
  repo_name: "localarchive",
  repo_url: listing.source_url,
  github_description: "Local-first Chrome extension for saving readable pages, selected text, Pocket imports, and portable Markdown/HTML/JSON exports.",
  ...
  release: {
    ...
    title: `Release LocalArchive v${manifest.version}`,
    zip: zipName
  },
  project_slug: "localarchive"
}, null, 2)}\n`);
